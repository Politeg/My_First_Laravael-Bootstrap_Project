                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('patronymic') is-invalid @enderror"
                               id="patronymic"
                               name="patronymic">@error('patronymic')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control @error('password_repeat') is-invalid @enderror"
                               id="password_repeat"
                               name="password_repeat">@error('password_repeat')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                        @enderror
