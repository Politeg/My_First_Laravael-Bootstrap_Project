                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td><img style="max-width: 150px"
                                     src="{{asset('storage/app/public/'.$product->product_photo)}}" alt="фото товара">
                            </td>
                                                ...
                                                <form method="POST" action="{{route('editProduct',$product)}}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number"
                                                               ...
                                                               id="product_count"
                                                               name="product_count" value="{{$product->product_count}}">
                                                        @error('product_count')
                                                        <div class="invalid-feedback">
                                                            {{$message}}
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="text-center">
                                                            <img style="max-width: 150px"
                                                                 src="{{asset('storage/app/public/'.$product->product_photo)}}"
                                                                 alt="Фото активное">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                ...
                                <div class="modal fade" id="deleteModal{{$product->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Удаление товара {{$product->product_name}} приведет к удалению всех
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{route('delProduct', $product)}}" method="POST">
                                                    @csrf
