            ...
            <div class="col-6">
                @if(session()->has('edit_category'))
                    <div class="alert alert-success">Вы успешно изменили
                        категорию {{session()->get('edit_category')}} на {{session()->get('old_edit_category')}}</div>
                @endif
                @if(session()->has('delete_category'))
                    <div class="alert alert-success">Вы успешно удалили
                        категорию {{session()->get('delete_category')}}</div>
                @endif
                <table class="table">
                    <thead>
                    <tr>
                                ...
                                <div class="modal fade" id="deleteModal{{$category->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Удаление категории {{$category->category_name}} приведет к удалению всех
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{route('delCategory', $category)}}" method="POST">
                                                    @csrf
