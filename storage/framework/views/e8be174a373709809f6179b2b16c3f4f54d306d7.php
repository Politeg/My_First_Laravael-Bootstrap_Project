            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div>
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php else: ?>
                            <a href="" class="btn-outline-primary btn">Корзина</a>
                            <a href="" class="btn-outline-primary btn">Заказы</a>
                        <?php endif; ?>
...
<?php /**PATH /srv/users/zvryrkkj/skxzirj-m1/resources/views/components/header.blade.php ENDPATH**/ ?>